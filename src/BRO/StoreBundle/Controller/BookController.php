...
use BRO\StoreBundle\Entity\Book;
use BRO\StoreBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BROStoreBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("BROStoreBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BROStoreBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BROStoreBundle:Book:edit.html.twig")
     */
